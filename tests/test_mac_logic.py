...
class Data:
    def __init__(self, **kwargs):
        ...
        self.is_error = kwargs.get('is_error', kwargs.get('isError', False))
...
class FakeDC:
    ...
    async def invoke(self, name, args, **kw):
        ...
        return Data(content=[], structured_content={'called': name})
...
class LogicTests(unittest.IsolatedAsyncioTestCase):
    ...
    def setUpClass(cls):
        ...
        modules['mcp.server.mcpserver'].MCPServer = FakeMCP
