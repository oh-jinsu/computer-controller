...
3. [Releases](https://github.com/oh-jinsu/mac-bridge/releases)에서 운영체제에 맞는 ZIP을 받으세요: **macOS `Mac-Bridge-...-macos26-arm64.zip` / Windows `Mac-Bridge-...-windows-x64.zip`**.
...
macOS는 **Mac Bridge.app → 응용 프로그램**으로 옮겨 실행하고, Windows는 압축을 푼 폴더의 **Mac Bridge.exe**를 실행합니다.

![macOS 설정 화면](docs/images/mac-bridge-settings.png)

## 선택 설정

**요청마다 승인창을 띄우려면:** 설정에서 **요청된 Mac/PC 작업 항상 허용**을 끄세요.
